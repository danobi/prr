...
- [Installation](./install.md)
    - [Install Binary](./install_binary.md)
    - [Acquire Github token](./install_github.md)
    - [Configure `prr`](./install_config.md)
- [Tutorial](./tutorial.md)
- [Vim integration](./vim.md)
